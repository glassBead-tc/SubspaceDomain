...
export class InitialMigration extends BaseMigration {
    ...
    validate(data) {
        ...
        const root = data;
        return (typeof root.users === 'object' &&
            Object.values(root.users).every(user => typeof user === 'object' &&
                typeof user.id === 'string' &&
                typeof user.machineIds === 'object' &&
                Object.values(user.machineIds).every(machine => typeof machine === 'object' &&
                    machine.registeredAt instanceof Date &&
                    typeof machine.clients === 'object' &&
                    Object.values(machine.clients).every(client => typeof client === 'object' &&
...
//# sourceMappingURL=v1_0_0.js.map